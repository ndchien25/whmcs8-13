...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = "*Performances globales du réseau selon une étude d'AV-Test. Cliquez ici pour :tagOpenconsulter le rapport complet:tagClose. Date de comparaison : 17 février 2021.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = ":tagOpenUtilisez NordVPN pour chiffrer votre activité en ligne:tagClose et renforcer la protection de votre connexion à tout moment et partout.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN propose une large gamme de fonctionnalités pour vous protéger contre les cybermenaces. En plus de la fonctionnalité :tagOpenThreat Protection:tagClose, vous pouvez bénéficier du commutateur :tagOpenKill Switch:tagClose automatique qui bloque votre connexion Internet si votre connexion VPN est interrompue, afin de garantir la sécurité de vos données. Le :tagOpenDouble VPN:tagClose vous aidera lorsqu'un niveau élevé de sécurité en ligne est requis en raison de la censure gouvernementale et des réglementations Internet strictes. Vous serez également protégé contre les :tagOpenfuites DNS:tagClose.";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "À chaque fois que vous téléchargez un fichier, la fonctionnalité :tagOpenThreat Protection:tagClose inspecte ce fichier à la recherche de logiciels malveillants.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "La fonctionnalité :tagOpenThreat Protection:tagClose bloque les publicités intrusives et les traqueurs web, analyse automatiquement les URL et bloque les URL malveillantes.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "La fonctionnalité :tagOpenThreat Protection:tagClose protège non seulement vos appareils, mais vous protège également. En bloquant les traqueurs, vous évitez les espions et les harceleurs en ligne.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "La fonctionnalité :tagOpenThreat Protection:tagClose de NordVPN change la donne en offrant encore plus d'avantages de sécurité et une meilleure protection en un seul clic supplémentaire.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Plus qu'un simple VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Même si vous n'avez rien à cacher, vous n'aimez probablement pas l'idée d'être sous surveillance ou suivi. Si les internautes choisissent les services VPN, c’est en priorité pour la confidentialité en ligne et la sécurité générale.:tagBreak:tagOpenVoici pourquoi !:tagClose";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "Sécurisez votre connexion et masquez votre adresse IP.:tagBreakBloquez les malwares, les traqueurs et les publicités.";
