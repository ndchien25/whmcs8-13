...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = "*Rendimiento global de la red según un estudio de AV-Test. Puede :tagOpenleer el informe completo:tagClose. Fecha de la comparación: 17 de febrero de 2021.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = ":tagOpenUtilice NordVPN con el fin de cifrar su actividad en línea:tagClose para una capa adicional de protección cuando y dondequiera que esté conectado.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN cuenta con una amplia gama de funciones para protegerle de las amenazas cibernéticas. Además de :tagOpenProtección contra amenazas:tagClose, dispone de un :tagOpenKill Switch:tagClose automático que bloquea su conexión a Internet si su conexión VPN se interrumpe, lo que garantiza que sus datos permanezcan seguros. :tagOpenDoble VPN:tagClose le ayudará cuando necesite un alto nivel de seguridad en línea debido a la censura gubernamental y las estrictas regulaciones de Internet. También estará protegido contra los :tagOpenfiltrados de DNS:tagClose.";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Cada vez que descarga un archivo, :tagOpenProtección contra amenazas:tagClose lo inspecciona en busca de malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = ":tagOpenProtección contra amenazas:tagClose bloquea anuncios intrusivos y rastreadores web, y analiza automáticamente las URL y bloquea las maliciosas.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = ":tagOpenProtección contra amenazas:tagClose no solo protege sus dispositivos, sino también a usted. La posibilidad de bloquear rastreadores le ayuda a evitar espías y acosadores en línea.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = ":tagOpenProtección contra amenazas:tagClose de NordVPN es un catalizador que ofrece aún más beneficios de seguridad y mejor protección con un solo clic adicional.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Más que una VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Aunque no tenga nada que ocultar, probablemente no le guste la idea de que le vigilen y rastreen. La principal razón por la que los internautas eligen servicios VPN es la privacidad en línea y la seguridad en general.:tagBreak:tagOpenAquí encontrará razones específicas de POR QUÉ:tagClose";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "Proteja su conexión y oculte su IP.:tagBreakBloquee malware, rastreadores y anuncios.";
...
$_LANG['store']['ox']['faq8']['answer'] = "OX App Suite es compatible con los siguientes idiomas: inglés, alemán, español, francés, italiano, neerlandés, polaco, 中文 简体, 中文 繁體 y 日本語";
...
$_LANG['store']['threesixtymonitoring']['websiteDiscover']['i2'] = "Maximice el tiempo de actividad resolviendo los problemas del sitio web antes de que ocurran con :tagOpenalertas instantáneas.:tagClose";
