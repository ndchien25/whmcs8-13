...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = "*Allgemeine Netzwerkleistung laut Untersuchungen von AV-Test. Sie können :tagOpenden vollständigen Bericht:tagClose versehen mit dem Datum des Vergleichs: 17. Februar 2021.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = ":tagOpenNutzen Sie NordVPN, um Ihre Online-Aktivitäten zu verschlüsseln,:tagClose für zusätzlichen Schutz, wann und wo immer Sie verbunden sind.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN bietet eine Vielzahl von Funktionen, um Sie vor Cyberbedrohungen zu schützen. Zusätzlich zum :tagOpenBedrohungsschutz:tagClose gibt es einen automatischen :tagOpenKill Switch:tagClose, der Ihre Internetverbindung blockiert, wenn Ihre VPN-Verbindung unterbrochen wird, und so sicherstellt, dass Ihre Daten sicher bleiben. :tagOpenDouble VPN:tagClose hilft, wenn aufgrund staatlicher Zensur und strenger Internetvorschriften ein hohes Maß an Online-Sicherheit erforderlich ist. Sie werden auch vor :tagOpenDNS-Lecks:tagClose geschützt sein.";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Wenn Sie eine Datei herunterladen, überprüft der :tagOpenBedrohungsschutz:tagClose sie auf Malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = ":tagOpenBedrohungsschutz:tagClose blockiert aufdringliche Werbung und Web-Tracker, scannt automatisch URLs und blockiert bösartige URLs.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = ":tagOpenBedrohungsschutz:tagClose schützt nicht nur Ihre Geräte, sondern auch Sie. Die Möglichkeit, Tracker zu blockieren, hilft Ihnen, Online-Spione und Stalker abzuwehren.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "Die :tagOpenBedrohungsschutz:tagClose-Funktion von NordVPN bietet noch mehr Sicherheitsvorteile und besseren Schutz mit einem einzigen zusätzlichen Klick.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Mehr als nur ein VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Auch wenn Sie nichts zu verbergen haben, gefällt Ihnen die Vorstellung, beobachtet und verfolgt zu werden, wahrscheinlich nicht. Der Hauptgrund, warum Internetnutzer VPN-Dienste wählen, ist Online-Privatsphäre und allgemeine Sicherheit.:tagBreak:tagOpenHier sind konkrete Gründe zum WARUM?:tagClose";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "Sichern Sie Ihre Verbindung und verbergen Sie Ihre IP.:tagBreakBlocken Sie Malware, Tracker und Werbung.";
